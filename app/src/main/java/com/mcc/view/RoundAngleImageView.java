	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray a = context.obtainStyledAttributes(attrs,
					R.styleable.gp_RoundAngleImageView);
			roundWidth = a.getDimensionPixelSize(
					R.styleable.gp_RoundAngleImageView_gp_roundwidth, roundWidth);
			roundHeight = a.getDimensionPixelSize(
					R.styleable.gp_RoundAngleImageView_gp_roundheight, roundHeight);
		} else {
